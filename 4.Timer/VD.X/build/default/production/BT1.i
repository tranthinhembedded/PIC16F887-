...
{
    0x00, 0x00, 0x00, 0x18, 0x14, 0x10, 0x10, 0x00,
    2, 9, 20, 0, 28, 20, 30, 0,
    0X0E, 0X09, 0X09, 0X1D, 0X09, 0X09, 0X0E, 0X00,
    0x04, 0x08, 0x12, 0x01, 0x12, 0x12, 0x1E, 0x00,
    0, 4, 0, 12, 4, 0, 4, 0,
    0x00, 0x0E, 0x11, 0x11, 0x11, 0x0E, 0x00, 0x04,
    8, 4, 0, 12, 20, 20, 30, 0,
    0, 0, 6, 2, 28, 20, 28, 0,
...
void load_custom_characters(const char* custom_data, unsigned char start_address) {
    unsigned char i = 0;
    lcd_put_byte(0, 0x40 + (start_address * 8));
    while(lcd_busy());
...
void main()
{
    ...
    int size_line1 = (sizeof(dat_line1) / sizeof(dat_line1[0]));
    int size_line3 = (sizeof(dat_line3) / sizeof(dat_line3[0]));
